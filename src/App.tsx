        ...
        <>
            ...
            {sharedWishListEmail && (
              <SharedWishListModal 
                ...
                wishlistId={sharedWishListId || 'default'}
                onClose={() => {
                  setSharedWishListEmail(null);
                  setSharedWishListMode(null);
                  setSharedWishListId(null);
                }} 
              />
            )}
        </>
  ...
  if (user && user.isFrozen) {
      return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-4">
          <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 text-center border border-blue-100 dark:border-blue-900">
            <div className="w-20 h-20 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-6">
              <Snowflake className="h-10 w-10 text-blue-600 dark:text-blue-400 animate-pulse" />
            </div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Account Frozen</h1>
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              Your account has been temporarily suspended by an administrator. Please contact support if you believe this is an error.
            </p>
            <button
              onClick={handleSignOut}
              className="w-full py-3 px-4 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-xl font-semibold hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors flex items-center justify-center gap-2"
            >
